...
export function buildFacebookGroupPrompt(input: FacebookGroupPromptInput): string {
  return [
    ...
    'מבנה: פתיחה חזקה על החידוש או נקודת עבודה מוכרת; מה חדש בפועל; למה זה חשוב; דוגמה מתהליך עסקי אמיתי; מה כדאי לבדוק במערכת; טיפ פרקטי; סיום עם שאלה עדינה שמזמינה שיתוף ניסיון.',
